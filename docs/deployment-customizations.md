...
- The script must contain all of the variables (denoted by `${example-variable}`) in the module-level [TFE startup script](https://github.com/hashicorp/terraform-azurerm-terraform-enterprise-hvd/templates/tfe_custom_data.sh.tpl)
