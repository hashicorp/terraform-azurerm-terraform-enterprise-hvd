...
This directory contains a ready-made Terraform configuration and an [example terraform.tfvars file](https://github.com/hashicorp/terraform-azurerm-terraform-enterprise-hvd/examples/main/terraform.tfvars.example) for deploying this module.
